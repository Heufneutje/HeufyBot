...
public class ChannelInfoEvent<T extends HeufyBot> extends Event<T> {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.getList() == null ? other.getList() != null : !this.getList().equals((java.lang.Object)other.getList())) return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.getList() == null ? 0 : this.getList().hashCode());
		return result;
	}
}