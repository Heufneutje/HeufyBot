...
public class UserListEvent<T extends HeufyBot> extends Event<T> {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.getUsers() == null ? other.getUsers() != null : !this.getUsers().equals((java.lang.Object)other.getUsers())) return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.getUsers() == null ? 0 : this.getUsers().hashCode());
		return result;
	}
}