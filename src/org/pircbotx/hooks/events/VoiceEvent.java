...
public class VoiceEvent<T extends HeufyBot> extends Event<T> implements GenericUserModeEvent<T> {
	...
	public java.lang.String toString() {
		return "VoiceEvent(channel=" + this.getChannel() + ", source=" + this.getSource() + ", recipient=" + this.getRecipient() + ", hasVoice=" + this.hasVoice + ")";
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.hasVoice ? 1231 : 1237);
		return result;
	}
}