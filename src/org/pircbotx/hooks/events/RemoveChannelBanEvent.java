...
public class RemoveChannelBanEvent<T extends HeufyBot> extends Event<T> implements GenericChannelModeEvent<T> {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.getHostmask() == null ? other.getHostmask() != null : !this.getHostmask().equals((java.lang.Object)other.getHostmask())) return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.getHostmask() == null ? 0 : this.getHostmask().hashCode());
		return result;
	}
}