 ...
 */
public abstract class Event<T extends HeufyBot> {
	...
	/**
	 * Returns the {@link HeufyBot} instance that this event originally came from
	 * @return A {@link HeufyBot} instance
	 */
	public T getBot() {
		return bot;
	}
	 ...
	 * and calls to {@link HeufyBot#sendRawLine(java.lang.String) }
