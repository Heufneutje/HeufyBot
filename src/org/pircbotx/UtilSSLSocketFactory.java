...
public class UtilSSLSocketFactory extends SSLSocketFactory {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.wrappedFactory == null ? other.wrappedFactory != null : !this.wrappedFactory.equals((java.lang.Object)other.wrappedFactory)) return false;
	...
	public int hashCode() {
		final int PRIME = 31;
		int result = 1;
		result = result * PRIME + (this.wrappedFactory == null ? 0 : this.wrappedFactory.hashCode());
		result = result * PRIME + (this.isTrustingAllCertificates() ? 1231 : 1237);
		result = result * PRIME + (this.isDiffieHellmanDisabled() ? 1231 : 1237);
		return result;
	}
	...
	public java.lang.String toString() {
		return "UtilSSLSocketFactory(wrappedFactory=" + this.wrappedFactory + ", trustingAllCertificates=" + this.isTrustingAllCertificates() + ", diffieHellmanDisabled=" + this.isDiffieHellmanDisabled() + ")";
	}
