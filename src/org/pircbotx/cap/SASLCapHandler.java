...
public class SASLCapHandler implements CapHandler {
	...
	public void handleLS(HeufyBot bot, List<String> capabilities) throws CAPException {
		...
		bot.sendCAPREQ("sasl"); else throw new CAPException("Server does not support SASL");
	}
	
	public void handleACK(HeufyBot bot, List<String> capabilities) {
		if (capabilities.contains("sasl")) 
	...
	public void handleUnknown(HeufyBot bot, String rawLine) throws CAPException {
		...
		if (parsedLine.length >= 1) if (parsedLine[1].equals("904") || parsedLine[1].equals("905")) {
			...
			if (!ignoreFail) throw new CAPException("SASL Authentication failed with message: " + parsedLine[3].substring(1));
			//Pretend like nothing happened
			done = true;
		} else if (parsedLine[1].equals("900") || parsedLine[1].equals("903")) done = true;
	}
