...
public class DccChat {
	...
	public synchronized void accept() throws IOException {
		if (!acceptable) throw new IOException("Connection already created");
		acceptable = false;
	...
	public String readLine() throws IOException {
		if (acceptable) throw new IOException("You must call the accept() method of the DccChat request before you can use it.");
