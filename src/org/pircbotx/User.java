...
public class User implements Comparable<User> {
	...
	/**
	 * Send a message to this user. See {@link HeufyBot#sendMessage(org.pircbotx.User, java.lang.String)}
	...
	public java.lang.String toString() {
		return "User(nick=" + this.getNick() + ", realName=" + this.getRealName() + ", login=" + this.getLogin() + ", hostmask=" + this.getHostmask() + ", away=" + this.isAway() + ", ircop=" + this.isIrcop() + ", server=" + this.getServer() + ", hops=" + this.getHops() + ", bot=" + this.getBot() + ", uuid=" + this.uuid + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		final java.lang.Object this$uuid = this.uuid;
		final java.lang.Object other$uuid = other.uuid;
	...
	public int hashCode() {
		...
		final java.lang.Object $uuid = this.uuid;
